...
\begin{itemize}
    \item \textbf{Skupienie 1 (Segment Ekonomiczny/Peryferyjny):} Charakteryzuje się najniższą ceną całkowitą oraz największą odległością od centrum miasta. Są to zazwyczaj mieszkania w dzielnicach sypialnianych o standardowym metrażu.
    \item \textbf{Skupienie 2 (Segment Kompaktowy/Miejski):} Obejmuje mniejsze lokale (kawalerki i małe 2-pokojowe) położone bliżej centrum, z bardzo wysoką dostępnością punktów użyteczności publicznej (POI).
    \item \textbf{Skupienie 3 (Segment Premium/Duże Metraże):} Grupa skupiająca najdroższe oferty o największej powierzchni. Są to często apartamenty w prestiżowych lokalizacjach lub duże mieszkania rodzinne.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Ocena jakości:} Skupienia charakteryzują się wysoką jednorodnością wewnątrzgałęziową. Klaster 1 (Premium) i Klaster 2 (Kompaktowy) są od siebie wyraźnie odseparowane pod względem ceny i metrażu, podczas gdy Klaster 3 (Peryferyjny) stanowi naturalne dopełnienie struktury rynku, grupując oferty o specyficznej lokalizacji.
